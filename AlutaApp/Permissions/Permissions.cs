namespace AlutaApp.Permissions
{
    public static class Permissions
    {
        ...
        public static class PromotionPayments
        {
            public const string View = "Permissions.PromotionPayments.View";
            public const string Create = "Permissions.PromotionPayments.Create";
            public const string Edit = "Permissions.PromotionPayments.Edit";
            public const string Delete = "Permissions.PromotionPayments.Delete";
        }
        ...
        public static class ChatGroupMessages
        {
            public const string View = "Permissions.ChatGroupMessages.View";
            public const string Create = "Permissions.ChatGroupMessages.Create";
            public const string Edit = "Permissions.ChatGroupMessages.Edit";
            public const string Delete = "Permissions.ChatGroupMessages.Delete";
        }
