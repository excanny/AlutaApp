...
//            //allPermissions.GetPermissions(typeof(Permissions.ApplicationUsers), roleId);
...
//            ////var allClaimValues = allModulesPermissions.Select(a => a.).ToList();
//            //var roleClaimValues = claims.Select(a => a.Value).ToList();
//            //var authorizedClaims = allClaimValues.Intersect(roleClaimValues).ToList();
//            ////var authorizedClaims = allModulesPermissions.Intersect(roleClaimValues).ToList();
...
//            {
//                await _roleManager.AddPermissionsClaim(role, claim.Value);
//            }
