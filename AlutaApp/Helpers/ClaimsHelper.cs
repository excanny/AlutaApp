...
namespace AlutaApp.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task AddPermissionsClaim(this RoleManager<ApplicationRole> roleManager, ApplicationRole role, string permission)
        {
